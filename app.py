...
# Load the dataset
dataset_path = 'E:\MIET\Major Project\dataset.xlsx'  
df = pd.read_excel(dataset_path)


# Sidebar navigation
menu = ["About", "Policy Recommendation",  "Insurance Risk Assessment"]
...
if choice == "Policy Recommendation":
    ...
    **Maturity Benefits:** When the life insurance policy matures, some life insurance plans offer the policyholder the full premium amount paid during the policy term.
    ...
    # st.title("Insurance Risk Assessment App")
    ...
    def insurance_risk_assessment():
        ...
        # You can perform more sophisticated risk assessment logic here based on the gathered information
    ...
    def calculate_risk_score(underwriting_info, risk_info, actuarial_info):
        # Replace this with your actual risk assessment logic
        # Here, a simple example is provided: summing the age and projected claim amount
        # risk_score = underwriting_info["age"] + actuarial_info["projected_claim_amount"]
        ...
        projected_claim_factor = actuarial_info["projected_claim_amount"] * 0.05
